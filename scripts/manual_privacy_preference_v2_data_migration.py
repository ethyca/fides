...
"""
Run in shell with:
python3 scripts/manual_privacy_preference_v2_data_migration.py -table privacypreferencehistory
python3 scripts/manual_privacy_preference_v2_data_migration.py -table servednoticehistory
