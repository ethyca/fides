...
def twilio_sms_secrets(saas_config) -> Dict[str, Any]:
    return {
        ...
        "twilio_from_phone": pydash.get(saas_config, "twilio_sms.twilio_from_phone") or secrets["twilio_from_phone"],
    }
...
# @pytest.fixture
# def test_non_strict_erasure_request_with_email(twilio_sms_erasure_identity_phone_number: str,
# ) -> Generator:
