...
from tests.api.v1.endpoints.privacy_request.test_privacy_request_endpoints import (
    stringify_date,
)
from tests.helpers.auth import generate_auth_header_for_user
...
class TestGetSystemsUserManages(SystemManagerUserEndpointTestBase):
    ...
    def test_get_systems_managed_by_user_wrong_scope(
        ...
        from fides.config import CONFIG
        from tests.helpers.auth import _generate_auth_header
