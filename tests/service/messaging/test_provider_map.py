"""PROVIDER_MAP completeness invariant test.
...
from fides.api.service.messaging.message_dispatch_service import PROVIDER_MAP


class TestProviderMapCompleteness:
    def test_all_service_types_have_providers(self):
        assert set(PROVIDER_MAP.keys()) == set(MessagingServiceType)
