...
class TestPutMessagingConfigSecretsAWSSES:
    ...
    def test_put_config_secrets(
        ...
        assert body["msg"] == "Secrets updated for MessagingConfig with key: my_aws_ses_config."
        ...
        assert "InvalidClientTokenId" in body["failure_reason"] or "AWS" in body["failure_reason"]
        assert (
