...
class TestManualTaskRelationships:
    ...
    # TODO: Add tests for task instances and field definitions, config and submissions when they are implemented
    # def test_task_instances_relationship(self, db: Session, manual_task: ManualTask):
    #     """Test relationship with task instances."""
    #     # Create an instance
    ...
    #     # Verify instances relationship
    #     assert len(manual_task.instances) == 1
    #     assert manual_task.instances[0].id == instance.id

    # def test_task_field_definitions_relationship(self, db: Session, manual_task: ManualTask):
    #     """Test relationship with task field definitions."""
    ...
    #     # Verify field_definitions relationship
    #     assert len(manual_task.field_definitions) == 1
    #     assert manual_task.field_definitions[0].id == field.id

    # def test_task_submissions_relationship(self, db: Session, manual_task: ManualTask):
    #     """Test relationship with task submissions."""
    #     # Create a submission
    ...
    #     # Verify submissions relationship
    #     assert len(manual_task.submissions) == 1
    #     assert manual_task.submissions[0].id == submission.id

    # def test_task_configs_relationship(self, db: Session, manual_task: ManualTask):
    #     """Test relationship with task configs."""
    #     # Create a config reference
    #     config_ref = ManualTaskReference(
    #         task_id=manual_task.id,
    #         reference_id="test_config",
    #         reference_type=ManualTaskReferenceType.manual_task_config,
    #     )
    #     db.add(config_ref)
    #     db.commit()

    #     # Verify configs relationship
    #     assert len(manual_task.configs) == 1
    #     assert manual_task.configs[0].id == "test_config"
