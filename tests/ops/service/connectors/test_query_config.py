...
class TestSQLQueryConfig:
    ...
    def test_generated_sql_query(self):
        ...
        assert (
            ...
            == "SELECT billing_address_id, customer_id, id FROM payment_card WHERE id = :id OR customer_id = :customer_id"
        )
        ...
        assert (
            ...
            == "SELECT billing_address_id, customer_id, id FROM payment_card WHERE id = :id"
        )
        ...
        assert (
            ...
            == "SELECT billing_address_id, customer_id, id FROM payment_card WHERE customer_id = :customer_id"
        )
