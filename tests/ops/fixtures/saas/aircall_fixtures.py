...
def aircall_secrets(saas_config):
    return {
        ...
        "api_key": pydash.get(saas_config, "aircall.api_key") or secrets["api_key"],
    }
...
@pytest.fixture(scope="function")
def aircall_erasure_identity_phone() -> str:
    return f"{cryptographic_util.generate_secure_random_string(10)}"
