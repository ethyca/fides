...
from tests.fides.fixtures.application_fixtures import *
from tests.fides.fixtures.async_fixtures import *
from tests.fides.fixtures.bigquery_fixtures import *
from tests.fides.fixtures.datahub_fixtures import *
from tests.fides.fixtures.detection_discovery_fixtures import *
from tests.fides.fixtures.dynamodb_fixtures import *
from tests.fides.fixtures.email_fixtures import *
from tests.fides.fixtures.fides_connector_example_fixtures import *
from tests.fides.fixtures.google_cloud_sql_mysql_fixtures import *
from tests.fides.fixtures.google_cloud_sql_postgres_fixtures import *
from tests.fides.fixtures.integration_fixtures import *
from tests.fides.fixtures.manual_fixtures import *
from tests.fides.fixtures.manual_webhook_fixtures import *
from tests.fides.fixtures.mariadb_fixtures import *
from tests.fides.fixtures.messaging_fixtures import *
from tests.fides.fixtures.mongodb_fixtures import *
from tests.fides.fixtures.mssql_fixtures import *
from tests.fides.fixtures.mysql_fixtures import *
from tests.fides.fixtures.okta_fixtures import *
from tests.fides.fixtures.postgres_fixtures import *
from tests.fides.fixtures.rds_mysql_fixtures import *
from tests.fides.fixtures.rds_postgres_fixtures import *
from tests.fides.fixtures.redshift_fixtures import *
from tests.fides.fixtures.saas import *
from tests.fides.fixtures.saas_erasure_order_fixtures import *
from tests.fides.fixtures.saas_example_fixtures import *
from tests.fides.fixtures.scylladb_fixtures import *
from tests.fides.fixtures.snowflake_fixtures import *
from tests.fides.fixtures.timescale_fixtures import *

ROOT_PATH = Path().absolute()
CONFIG = get_config()
TEST_CONFIG_PATH = "tests/fides/ctl/test_config.toml"
TEST_INVALID_CONFIG_PATH = "tests/fides/ctl/test_invalid_config.toml"
TEST_DEPRECATED_CONFIG_PATH = "tests/fides/ctl/test_deprecated_config.toml"
...
def integration_config():
    yield load_toml("tests/fides/ops/integration_test_config.toml")
