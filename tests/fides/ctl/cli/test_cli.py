    ...
    def test_annotate(
        ...
        result = test_cli_runner.invoke(
            ...
            [
                ...
                "annotate",
                "dataset",
                "tests/fides/ctl/data/dataset_missing_categories.yml",
            ],
            input="user\n",
        )
        print(result.output)
        ...
        with open(
            "tests/fides/ctl/data/dataset_missing_categories.yml", "w"
        ) as current_dataset_yml:
    ...
    def test_regression_annotate_dataset(
        ...
        test_cli_runner.invoke(
            ...
            [
                ...
                "annotate",
                "dataset",
                "tests/fides/ctl/data/failing_direction.yml",
            ],
            input="user\n",
        )
        with open("tests/fides/ctl/data/failing_direction.yml", "r") as dataset_yml:
            try:
                dataset_yml = yaml.safe_load(dataset_yml)
    ...
    def test_evaluate_with_declaration_pass(
        ...
        result = test_cli_runner.invoke(
            ...
            [
                ...
                test_config_path,
                "evaluate",
                "tests/fides/ctl/data/passing_declaration_taxonomy.yml",
            ],
        )
        print(result.output)
        assert result.exit_code == 0
    ...
    def test_evaluate_with_declaration_failed(
        ...
        result = test_cli_runner.invoke(
            ...
            [
                ...
                test_config_path,
                "evaluate",
                "tests/fides/ctl/data/failing_declaration_taxonomy.yml",
            ],
        )
        print(result.output)
        assert result.exit_code == 1
    ...
    def test_evaluate_with_dataset_failed(
        ...
        result = test_cli_runner.invoke(
            ...
            [
                ...
                test_config_path,
                "evaluate",
                "tests/fides/ctl/data/failing_dataset_taxonomy.yml",
            ],
        )
        print(result.output)
        assert result.exit_code == 1
    ...
    def test_evaluate_with_dataset_field_failed(
        ...
        result = test_cli_runner.invoke(
            ...
            [
                ...
                test_config_path,
                "evaluate",
                "tests/fides/ctl/data/failing_dataset_collection_taxonomy.yml",
            ],
        )
        print(result.output)
        assert result.exit_code == 1
    ...
    def test_evaluate_with_dataset_collection_failed(
        ...
        result = test_cli_runner.invoke(
            ...
            [
                ...
                test_config_path,
                "evaluate",
                "tests/fides/ctl/data/failing_dataset_field_taxonomy.yml",
            ],
        )
        print(result.output)
        assert result.exit_code == 1
    ...
    def test_evaluate_nested_field_fails(
        ...
        result = test_cli_runner.invoke(
            ...
            [
                ...
                test_config_path,
                "evaluate",
                "tests/fides/ctl/data/failing_nested_dataset.yml",
            ],
        )
        print(result.output)
        assert result.exit_code == 1
