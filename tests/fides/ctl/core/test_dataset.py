...
TEST_DATABASE_PARAMETERS = {
    "postgresql": {
        ...
        "init_script_path": "tests/fides/ctl/data/example_sql/postgres_example.sql",
        "is_external": False,
        "expected_collection": {
            "public": {
    ...
    "mysql": {
        "url": MYSQL_URL,
        "setup_url": MYSQL_URL,
        "init_script_path": "tests/fides/ctl/data/example_sql/mysql_example.sql",
        "is_external": False,
        "expected_collection": {
            "mysql_example": {
                "visit": ["email", "last_visit"],
    ...
    "mssql": {
        ...
        "username": "sa",
        "password": "SQLserver1",
        "init_script_path": "tests/fides/ctl/data/example_sql/sqlserver_example.sql",
        "is_external": False,
        "expected_collection": {
            "dbo": {
                "visit": ["email", "last_visit"],
    ...
    #     "init_script_path": "tests/fides/ctl/data/example_sql/snowflake_example.sql",
    #     "is_external": True,
    #     "expected_collection": {
    #         "PUBLIC": {
    #             "VISIT": ["EMAIL", "LAST_VISIT"],
    ...
    "redshift": {
        ...
        "init_script_path": "tests/fides/ctl/data/example_sql/redshift_example.sql",
        "is_external": True,
        "expected_collection": {
            "public": {
                "visit": ["email", "last_visit"],
