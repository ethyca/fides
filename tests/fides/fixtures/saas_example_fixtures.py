...
def saas_example_config() -> Dict:
    return load_config("tests/fides/fixtures/saas/test_data/saas_example_config.yml")


@pytest.fixture
def saas_example_opt_out_only_config() -> Dict:
    return load_config(
        "tests/fides/fixtures/saas/test_data/saas_example_opt_out_only_config.yml"
    )
...
def saas_example_consent_preferences_config() -> Dict:
    return load_config(
        "tests/fides/fixtures/saas/test_data/saas_example_consent_preferences_config.yml"
    )
...
def planet_express_config() -> str:
    return load_yaml_as_string(
        "tests/fides/fixtures/saas/test_data/planet_express/planet_express_config.yml"
    )
...
def planet_express_invalid_config() -> str:
    return load_yaml_as_string(
        "tests/fides/fixtures/saas/test_data/planet_express/planet_express_invalid_config.yml"
    )
...
def planet_express_dataset() -> str:
    return load_yaml_as_string(
        "tests/fides/fixtures/saas/test_data/planet_express/planet_express_dataset.yml"
    )
...
def planet_express_invalid_dataset() -> str:
    return load_yaml_as_string(
        "tests/fides/fixtures/saas/test_data/planet_express/planet_express_invalid_dataset.yml"
    )
...
def planet_express_icon() -> str:
    return load_as_string(
        "tests/fides/fixtures/saas/test_data/planet_express/planet_express.svg"
    )
...
def planet_express_functions() -> str:
    return load_as_string(
        "tests/fides/fixtures/saas/test_data/planet_express/planet_express_functions.py"
    )
...
def saas_async_dataset() -> Dict:
    return load_dataset(
        "tests/fides/fixtures/saas/test_data/saas_async_callback_dataset.yml"
    )[0]
...
@pytest.fixture
def saas_async_polling_example_connection_config(
    db: Session,
    saas_async_polling_example_config: Dict[str, Any],
    saas_async_example_secrets: Dict[str, Any],
) -> Generator:
    fides_key = saas_async_polling_example_config["fides_key"]
    connection_config = ConnectionConfig.create(
        db=db,
        data={
            "key": fides_key,
            ...
            "access": AccessLevel.write,
            "secrets": saas_async_example_secrets,
            "saas_config": saas_async_polling_example_config,
        },
    )
    yield connection_config
    connection_config.delete(db)
...
@pytest.fixture
def saas_async_polling_example_dataset_config(
    db: Session,
    saas_async_polling_example_connection_config: ConnectionConfig,
    saas_async_polling_example_dataset: Dict,
) -> Generator:
    fides_key = saas_async_polling_example_dataset["fides_key"]
    saas_async_polling_example_connection_config.name = fides_key
    ...
    dataset = DatasetConfig.create(
        db=db,
        data={
            "connection_config_id": saas_async_polling_example_connection_config.id,
            "fides_key": fides_key,
            "ctl_dataset_id": ctl_dataset.id,
        },
    )
...
def saas_consent_request_override_config() -> Dict:
    return load_config(
        "tests/fides/fixtures/saas/test_data/saas_consent_request_override_config.yml"
    )
...
def saas_consent_request_override_dataset() -> Dict:
    return load_dataset(
        "tests/fides/fixtures/saas/test_data/saas_consent_request_override_dataset.yml"
    )[0]
