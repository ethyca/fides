...
class ConditionalDependencyBase(Base):
    ...
    This class provides a common structure for storing condition trees as JSONB
    ...
    Concrete Implementations:
        ...
        - DigestCondition: Multiple condition trees per digest config
    ...
    Usage Pattern:
        ...
        3. Add foreign key to parent entity (manual_task_id, digest_config_id, etc.)
        4. Implement get_root_condition() classmethod

    Example condition_tree JSONB:
        # Single leaf condition
        {"field_address": "user.role", "operator": "eq", "value": "admin"}

        # Group with nested conditions
        {
    ...
    def get_root_condition(cls, db: Session, **kwargs: Any) -> Optional[Condition]:
        ...
        Returns:
            Optional[Condition]: Condition tree (ConditionLeaf or ConditionGroup) or None
        ...
        raise NotImplementedError(
            ...
            f"This method should query for the condition row and return the "
            f"deserialized condition_tree, or None if not found."
        )
