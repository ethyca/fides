...
class FidesUserEmailVerification(Base):
    """Stores hashed email verification tokens for the self-service email verification flow."""

    @declared_attr
    def __tablename__(self) -> str:
        return "fides_user_email_verification"
    ...
    def hash_token(cls, token: str, encoding: str = "UTF-8") -> tuple[str, str]:
        """Hash a verification token with a generated salt."""
        salt = generate_salt()
