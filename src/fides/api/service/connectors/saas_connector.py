...
class SaaSConnector(BaseConnector[AuthenticatedClient], Contextualizable):
    ...
    def retrieve_data(
        ...
        logger.info("privacy_request #  {}", privacy_request.id)
        ...
        for read_request in read_requests:
            rows, awaiting_async_callback = self.execute_read_request(
                policy,
                privacy_request,
                node,
                read_request,
    ...
    def execute_read_request(
        ...
        return rows, awaiting_async_callback
