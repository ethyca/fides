...
def get_custom_metadata_cache_key(
    privacy_request_id: str, custom_metadata_attribute: str
) -> str:
    """Return the key at which to save this PrivacyRequest's custom metadata for the passed in attribute"""
    return f"id-{privacy_request_id}-custom-metadata-{custom_metadata_attribute}"
