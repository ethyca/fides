...
class SQLConditionTranslator:
    ...
    OPERATOR_MAPPING = {
        ...
        Operator.list_contains: "IN",
        Operator.not_in_list: "NOT IN",
        # String operators
        Operator.starts_with: "LIKE",
        Operator.ends_with: "LIKE",
        Operator.contains: "LIKE",
        # List-to-list operators (require special handling)
        Operator.list_intersects: "OVERLAPS",  # PostgreSQL specific
        Operator.list_subset: "CONTAINED BY",  # PostgreSQL specific
        Operator.list_superset: "CONTAINS",  # PostgreSQL specific
        Operator.list_disjoint: "NOT OVERLAPS",  # PostgreSQL specific
    }
    ...
    def _translate_list_operator(
        ...
        if condition.operator == Operator.list_contains:
            ...
            if isinstance(condition.value, list):
                ...
                # If column value is a list, check if user value is in it using PostgreSQL array contains
    ...
    def generate_select_query(
        ...
        query_parts = [f"SELECT {fields_str}", f"FROM {self.table_name}"]
    ...
    def generate_count_query(
        ...
        # Build COUNT query
        query_parts = ["SELECT COUNT(*)", f"FROM {self.table_name}"]
