...
def upgrade():
    ...
    op.create_table('privacyrequesterror',
    ...
    sa.ForeignKeyConstraint(['privacy_request_id'], ['privacyrequest.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_privacyrequesterror_id'), 'privacyrequesterror', ['id'], unique=False)
