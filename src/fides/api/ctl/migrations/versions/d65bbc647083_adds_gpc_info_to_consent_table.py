...
def upgrade():
    ...
    op.add_column('consent', sa.Column('has_gpc_flag', sa.Boolean(), server_default=False, default=False, nullable=True))
    op.add_column('consent', sa.Column('conflicts_with_gpc', sa.Boolean(), server_default=False, default=False, nullable=True))
    op.execute("UPDATE consent SET has_gpc_flag = false")
    op.alter_column('consent', 'has_gpc_flag', nullable=False)
    op.execute("UPDATE consent SET conflicts_with_gpc = false")
    op.alter_column('consent', 'conflicts_with_gpc', nullable=False)
