...
def upgrade():
    ...
    op.add_column('consent', sa.Column('has_gpc_flag', sa.Boolean(), server_default='0', default=False, nullable=True))
    op.add_column('consent', sa.Column('conflicts_with_gpc', sa.Boolean(), server_default='0', default=False, nullable=True))
