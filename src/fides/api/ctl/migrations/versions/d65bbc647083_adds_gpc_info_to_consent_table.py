...
def upgrade():
    ...
    op.add_column('consent', sa.Column('has_gpc_flag', sa.Boolean(), default=False, nullable=True))
    op.add_column('consent', sa.Column('conflicts_with_gpc', sa.Boolean(), default=False, nullable=True))
