...
def upgrade():
    ...
    op.create_table('privacyrequestnotifications',
    ...
    op.create_index(op.f('ix_privacyrequestnotifications_id'), 'privacyrequestnotifications', ['id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_privacyrequestnotifications_id'), table_name='privacyrequestnotifications')
