...
def upgrade():
    ...
    op.create_foreign_key(
        "connectionconfig_system_id_fkey", "connectionconfig", "ctl_systems", ["system_id"], ["id"]
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("connectionconfig_system_id_fkey", "connectionconfig", type_="foreignkey")
