...
def downgrade():
    ...
    try:
        op.drop_index(
            "ix_stagedresource_system_vendor_consent", table_name="stagedresource"
        )
    except Exception:
        logger.debug(
            "Index ix_stagedresource_system_vendor_consent does not exist, skipping drop"
        )
    ...
    try:
        ...
        logger.debug(
            "Index ix_stagedresource_monitor_config_resource_type_consent does not exist, skipping drop"
        )
    # ### end Alembic commands ###
