...
def upgrade():
    ...
    op.create_index('ix_manual_task_instance_entity_id', 'manual_task_instance', ['entity_id'])
    op.create_index('ix_manual_task_instance_entity_type', 'manual_task_instance', ['entity_type'])
    ...
    op.create_index('ix_manual_task_instance_entity', 'manual_task_instance', ['entity_type', 'entity_id'])
    ...
    # Composite index for common query pattern
    op.create_index('ix_manual_task_submission_instance_field', 'manual_task_submission', ['instance_id', 'field_id'])


def downgrade():
    # Drop indexes first
    op.drop_index('ix_manual_task_submission_instance_field', table_name='manual_task_submission')
    op.drop_index('ix_manual_task_submission_submitted_at', table_name='manual_task_submission')
    op.drop_index('ix_manual_task_submission_submitted_by', table_name='manual_task_submission')
    op.drop_index('ix_manual_task_submission_instance_id', table_name='manual_task_submission')
    op.drop_index('ix_manual_task_submission_field_id', table_name='manual_task_submission')
    op.drop_index('ix_manual_task_submission_config_id', table_name='manual_task_submission')
    op.drop_index('ix_manual_task_submission_task_id', table_name='manual_task_submission')

    op.drop_index('ix_manual_task_instance_entity', table_name='manual_task_instance')
    op.drop_index('ix_manual_task_instance_completed_at', table_name='manual_task_instance')
    op.drop_index('ix_manual_task_instance_status', table_name='manual_task_instance')
    op.drop_index('ix_manual_task_instance_entity_type', table_name='manual_task_instance')
    op.drop_index('ix_manual_task_instance_entity_id', table_name='manual_task_instance')
    op.drop_index('ix_manual_task_instance_config_id', table_name='manual_task_instance')
