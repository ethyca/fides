...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('manual_task_log',
    ...
    sa.ForeignKeyConstraint(['config_id'], ['manual_task_config.id'], name='fk_manual_task_log_config_id', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['instance_id'], ['manual_task_instance.id'], name='fk_manual_task_log_instance_id', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['task_id'], ['manual_task.id'], name='manual_task_log_task_id_fkey', ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id', name='manual_task_log_pkey')
    )
    op.create_index('ix_manual_task_log_user_id', 'manual_task_log', ['user_id'], unique=False)
    op.create_index('ix_manual_task_log_task_id', 'manual_task_log', ['task_id'], unique=False)
    op.create_index('ix_manual_task_log_status', 'manual_task_log', ['status'], unique=False)
    op.create_index('ix_manual_task_log_instance_id', 'manual_task_log', ['instance_id'], unique=False)
    op.create_index('ix_manual_task_log_created_at', 'manual_task_log', ['created_at'], unique=False)
    op.create_index('ix_manual_task_log_config_id', 'manual_task_log', ['config_id'], unique=False)
    # ### end Alembic commands ###
