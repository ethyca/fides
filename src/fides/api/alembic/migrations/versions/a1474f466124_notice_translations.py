...
def upgrade():
    ...
    op.add_column(
        "privacynoticehistory", sa.Column("translation_id", sa.String(), nullable=False)
    )
    op.alter_column(
        "privacynoticehistory",
        "regions",
    ...
    op.create_foreign_key(
        None, "privacynoticehistory", "noticetranslation", ["translation_id"], ["id"]
    )
    op.add_column(
