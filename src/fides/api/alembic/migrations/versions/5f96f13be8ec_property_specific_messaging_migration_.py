...
from sqlalchemy.engine import Connection, ResultProxy, LegacyCursorResult
...
def upgrade():
    ...
    templates_from_db: List[str] = [template.type for template in existing_templates.all()]
...
def downgrade():
    ...
    bind.execute(text("DELETE FROM plus_property WHERE name LIKE 'Default Property Autogenerated'"))
    # ### end Alembic commands ###
