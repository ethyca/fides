...
GPC_TRANSLATIONS = {
    ...
    "sr-Latn": {
        "gpc_label": 'Globalna kontrola privatnosti',
        "gpc_description": 'Vaša globalna postavka kontrole privatnosti se poštuje. Automatski ste isključeni iz slučajeva korišćenja podataka koji podležu globalnoj kontroli privatnosti.',
