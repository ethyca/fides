...
def upgrade():
    ...
    sa.Column('data_categories', postgresql.ARRAY(sa.String()), server_default='{}', nullable=False),
    ...
    sa.Column('features', postgresql.ARRAY(sa.String()), server_default='{}', nullable=False),
    ...
    op.create_index(op.f('ix_data_purpose_id'), 'data_purpose', ['id'], unique=True)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('data_consumer_id', 'data_purpose_id', name='uq_data_consumer_purpose')
    )
