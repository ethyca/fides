...
def generate_dynamo_db_datasets(aws_config: Optional[AWSConfig], single_dataset: bool) -> List[Dataset]:
    """
    ...
    dynamo_dataset = create_dynamodb_dataset(described_dynamo_tables, single_dataset=single_dataset)
