...
from fides.service.privacy_request.async_dsr.handlers.polling_attachment_handler import (
...
from fides.service.privacy_request.async_dsr.handlers.polling_sub_request_handler import (
...
if TYPE_CHECKING:
    ...
    from fides.connectors.saas.saas_query_config import (
        SaaSQueryConfig,
    )
