...
class SecuritySettings(FidesSettings):
    ...
    oauth_root_client_secret_hash: Tuple = Field(
        default=(),
    ...
    parent_server_password: str = Field(
        default="",
    ...
    parent_server_username: str = Field(
        default="",
    ...
    enable_audit_log_resource_middleware: bool = Field(
        default=False,
        description="Either enables the collection of audit log resource data or bypasses the middleware",
    )

    bastion_server_host: str = Field(
        default="", description="An optional field to store the bastion server host"
    )
    bastion_server_ssh_username: str = Field(
        default="",
        description="An optional field to store the username used to access the bastion server",
    )
    bastion_server_ssh_private_key: str = Field(
        default="",
