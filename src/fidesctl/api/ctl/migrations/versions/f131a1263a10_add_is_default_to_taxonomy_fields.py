...
def upgrade():
    ...
    op.add_column('data_categories', sa.Column('is_default', sa.BOOLEAN(), nullable=True))
    op.drop_index('ix_data_categories_id', table_name='data_categories')
    op.create_index(op.f('ix_data_categories_id'), 'data_categories', ['id'], unique=False)
    op.add_column('data_qualifiers', sa.Column('is_default', sa.BOOLEAN(), nullable=True))
    op.drop_index('ix_data_qualifiers_id', table_name='data_qualifiers')
    op.create_index(op.f('ix_data_qualifiers_id'), 'data_qualifiers', ['id'], unique=False)
