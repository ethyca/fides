...
//    val f2 = DatasetFieldGen.sample.get.copy(creationTime = None, lastUpdateTime = None, name = "f2")
//    val f3  = DatasetFieldGen.sample.get.copy(creationTime = None, lastUpdateTime = None, name = "f3")
//    val f4  = DatasetFieldGen.sample.get.copy(creationTime = None, lastUpdateTime = None, name = "f5")
//
//    val ds =
//      DatasetGen.sample.get.copy(
//        creationTime = None,
//        lastUpdateTime = None,
//        fields = Some(Seq(f1, f2, f3))
//      )
//
