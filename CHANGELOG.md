...
- Fixed missing reference value validation in SaaS requests to apply to all request types, not just access requests [#6782](https://github.com/ethyca/fides/pull/6782)
