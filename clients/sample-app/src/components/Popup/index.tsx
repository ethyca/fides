...
const Popup = ({ trigger }: Props) => {
  ...
  return (
    <div className={`${css.popup} ${className}`}>
      ...
      >
        <path
          d="M8.99996 17.3333C4.39746 17.3333 0.666626 13.6025 0.666626 8.99999C0.666626 4.39749 4.39746 0.666656 8.99996 0.666656C13.6025 0.666656 17.3333 4.39749 17.3333 8.99999C17.3333 13.6025 13.6025 17.3333 8.99996 17.3333ZM8.16913 12.3333L14.0608 6.44082L12.8825 5.26249L8.16913 9.97666L5.81163 7.61916L4.63329 8.79749L8.16913 12.3333Z"
          fill="white"
        />
      </svg>
      <svg
