...
export interface Fides {
   ...
   * @param options.purposeMapping - Maps Fides consent keys to Google consent types. For example, map 'analytics' to ['analytics_storage'] and 'advertising' to ['ad_storage', 'ad_personalization', 'ad_user_data']
   * @param options.debug - Enable debug logging
   *
   * @example
   * Basic usage with consent mapping:
   * ```html
   * <head>
   *   <script src="path/to/fides.js"></script>
   *   <script>
