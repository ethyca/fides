...
export type ExperienceConfig = {
  ...
  updated_at: string;
  component: ComponentType;
  translations?: Array<ExperienceConfigTranslation>; // NOTE: uses our client-side ExperienceConfigTranslation type
...
export type PrivacyNotice = {
  ...
  translations?: Array<PrivacyNoticeTranslation>; // NOTE: uses our client-side PrivacyNoticeTranslation type
