...
export const PrivacyRequestMetrics = () => {
  ...
  return (
    <Stack align="center" py={["6", "16"]} px={5} spacing={10} className="pc-page-metrics">
      ...
      <Box className="pc-metrics-table" w="100%" maxWidth={1080} overflowX="auto">
        <Box
          as="table"
          w="100%"
          fontSize={["xs", "sm"]}
      ...
      <Box className="pc-metrics-disclaimer" w="100%" maxWidth={1080} borderRadius="md" p={5}>
