...
export type CreateConnectionConfigurationWithSecretsExtended = {
  ...
  disabled?: boolean;
  description?: string;
  secrets?: (MongoDBDocsSchema | PostgreSQLDocsSchema | MySQLDocsSchema | GoogleCloudSQLMySQLDocsSchema | GoogleCloudSQLPostgresDocsSchema | RedshiftDocsSchema | SnowflakeDocsSchema | MSSQLDocsSchema | MariaDBDocsSchema | BigQueryDocsSchema | SaaSSchema | EmailDocsSchema | ManualWebhookSchemaforDocs | TimescaleDocsSchema | FidesDocsSchema | SovrnDocsSchema | DynamoDBDocsSchema | S3DocsSchema | ScyllaDocsSchema);
