...
import type { UnverifiedIdentity } from "./UnverifiedIdentity";

/**
 * Request body for saving PrivacyPreferences using an unverified identities endpoint.
 *
 ...
 */
export type UnverifiedPrivacyPreferencesRequest = {
  ...
  browser_identity: UnverifiedIdentity;
  code?: string | null;
};
