...
import { SystemLink } from "~/mocks/system-links/data";
import {
...
interface IntegrationTableData extends ConnectionConfigurationResponse {
  ...
  // TEMP: remove in favor of autogenerated types
  linked_systems?: SystemLink[];
}
  ...
  const columns: ColumnsType<IntegrationTableData> = [
    ...
    },
    {
      ...
      render: (_, { linked_systems }) =>
        linked_systems && (
          <ListExpandableCell
            values={linked_systems.map(
              (link) => link.system_name ?? link.system_fides_key,
            )}
            valueSuffix="systems"
          />
        ),
