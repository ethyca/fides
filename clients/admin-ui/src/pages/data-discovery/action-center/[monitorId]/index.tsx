...
import { DiscoveredAssetsBySystemsTable } from "~/features/data-discovery-and-detection/action-center/tables/DiscoveredAssetsBySystemsTable";
...
const MonitorResultSystems: NextPage = () => {
  ...
  return (
    <FixedLayout title="Action center - Assets by system">
      ...
      />
      <DiscoveredAssetsBySystemsTable monitorId={monitorId} />
    </FixedLayout>
  );
};
