...
const EmailChipList = forwardRef(({ ...props }: FieldArrayRenderProps, ref) => {
  ...
  return (
    <FormControl
      alignItems="baseline"
      display="inline-flex"
      isInvalid={!!props.form.errors.emails}
      isRequired
    >
      ...
      <VStack align="flex-start" w="inherit">
        ...
        <Input
          ...
          value={inputValue}
        />
        <FormErrorMessage>{props.form.errors.emails}</FormErrorMessage>
        {emails.length > 0 && (
