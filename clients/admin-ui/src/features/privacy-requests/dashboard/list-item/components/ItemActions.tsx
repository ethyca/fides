...
import ApprovePrivacyRequestModal from "~/features/privacy-requests/dashboard/ApprovePrivacyRequestModal";
import { useMutations } from "~/features/privacy-requests/dashboard/hooks/useMutations";
...
interface ItemActionsProps extends StackProps {
...
export const ItemActions = ({
  subjectRequest,
  ...props
}: ItemActionsProps): JSX.Element | null => {
