...
// Re-export autogenerated types with aliases for backward compatibility
export type PrivacyAssessmentResponse = AssessmentResponse;
// eslint-disable-next-line @typescript-eslint/naming-convention
export type Page_PrivacyAssessmentResponse_ = Page_AssessmentResponse_;
export type CreatePrivacyAssessmentRequest = CreateAssessmentRequest;
...
// Keep these union types for type narrowing (autogenerated types use string)
export type AssessmentStatus = "in_progress" | "completed" | "outdated";
export type RiskLevel = "high" | "medium" | "low";

export interface PrivacyAssessmentDetailResponse extends AssessmentResponse {
