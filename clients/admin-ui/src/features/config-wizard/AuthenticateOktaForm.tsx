...
// TODO: This should be replaced with the autogenerated OktaConfig type once the backend
// API is updated to support OAuth2 Client Credentials (clientId + privateKey + scopes)
// instead of the simple token-based authentication.
