...
/** Zip with should apply to tuple */
// export const zipWith = <L, R, M>(left: Record<string, L>, right: Record<string, R>, func: (l?: L, r?: R) => M): Record<string, M> => {
//   const keys = [
//     ...Object.keys(left),
//     ...Object.keys(right)
//   ]
//
//   return Object.fromEntries(keys.map((key): [string, M] => {
//     return [key, func(left?.[key], right?.[key])]
//   }))
// }
