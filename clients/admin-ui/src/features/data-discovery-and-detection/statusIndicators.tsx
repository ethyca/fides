...
export const AdditionIndicator = () => (
  <RightUpArrowIcon color="green.400" boxSize={2} data-testid="add-icon" />
);

export const RemovalIndicator = () => (
  <RightDownArrowIcon color="red.400" boxSize={2} data-testid="remove-icon" />
);

export const ClassificationIndicator = () => (
  <TagIcon color="orange.400" boxSize={3} data-testid="classify-icon" />
);
...
export const MonitoredIndicator = () => (
  <CircleIcon color="green.400" boxSize={2} data-testid="monitored-icon" />
);

export const MutedIndicator = () => (
  <CircleIcon color="red.400" boxSize={2} data-testid="muted-icon" />
);

export const InProgressIndicator = () => (
  <CircleIcon color="orange.400" boxSize={2} data-testid="in-progress-icon" />
);
