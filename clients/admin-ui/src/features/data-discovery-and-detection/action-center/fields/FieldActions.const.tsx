...
export const ACTIONS_DISABLED_MESSAGE: Record<
  ...
  string
> = {
  [APPROVE]: "You can only review resources with a data category applied",
  [CLASSIFY]:
...
export const FIELD_ACTION_CONFIRMATION_MESSAGE = {
  ...
  approve: (targetItemCount: number) =>
    `Are you sure you want to review ${targetItemCount.toLocaleString()} ${pluralize(targetItemCount, "resource", "resources")}?`,
