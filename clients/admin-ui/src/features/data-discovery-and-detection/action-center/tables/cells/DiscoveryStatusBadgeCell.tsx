  ...
  return (
    <>
      {consentAggregated === AggregatedConsent.WITHOUT_CONSENT && (
        <Tooltip title="Asset was detected before the user gave consent or without any consent. Click icon for more details">
          <Tag
            color="error"
      ...
      {consentAggregated === AggregatedConsent.UNKNOWN && (
        <Tooltip title="You may need to rerun the monitor to get the latest status">
          <Tag>Unknown</Tag>
        </Tooltip>
      )}
      {isOpen && (
