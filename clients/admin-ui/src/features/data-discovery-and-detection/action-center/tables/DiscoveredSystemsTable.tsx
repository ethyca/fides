...
import { useDiscoveredSystemColumns } from "../hooks/useDiscoveredSystemColumns";
import { MonitorSystemAggregate } from "../types";

interface DiscoveredSystemsTableProps {
  monitorId: string;
}

export const DiscoveredSystemsTable = ({
  monitorId,
}: DiscoveredSystemsTableProps) => {
  ...
  const { columns } = useDiscoveredSystemColumns({
