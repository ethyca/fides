...
export type DiscoveredAssetResponse = StagedResourceAPIResponse & {
  data_uses?: string[];
};
export interface DiscoveredAssetPaginatedResponse
  extends PaginatedResponse<DiscoveredAssetResponse> {}
