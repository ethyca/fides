  ...
  return (
    <ConfigColumnLayout buttonPanel={buttonPanel}>
      ...
      {/* Register array/object fields managed by ScrollableList so
          ...
          because the translation sub-form uses nested name paths like
          ['translations', 0, 'title'] which conflict with a flat name. */}
      ...
      <div className="pt-6">
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: "Experience name is required" }]}
        >
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: "Experience type is required" }]}
        >
          <Select
            options={useMemo(() => {
          ...
          >
            <Checkbox.Group
              options={resurfaceBehaviorOptions.map((option) => ({
                ...
                value: option.value,
                disabled:
                  option.value === ResurfaceBehavior.DISMISS && !dismissable,
              }))}
      ...
      <div>
        ...
        <ScrollableList
          ...
          setValues={(newValues) => form.setFieldValue("regions", newValues)}
          getItemLabel={(item) => {
          ...
          <div>
            ...
            {!!allowVendorAssetDisclosure && (
              <Form.Item
                ...
                dependencies={["allow_vendor_asset_disclosure", "component"]}
                className="!mb-0 pt-6"
                rules={[
                  {
                    validator: (_, value) => {
