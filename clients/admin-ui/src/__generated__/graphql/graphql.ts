...
export type DashboardOverviewQuery = {
  ...
  | { __typename?: "Query"; agentBriefing?: never }
);
...
export type DashboardPriorityActionsQuery = {
  __typename?: "Query";
  priorityActions: {
    __typename?: "PriorityActionsPage";
    total: number;
...
export type DashboardActivityFeedQuery = {
  __typename?: "Query";
  activityFeed: {
    __typename?: "ActivityFeedPage";
    total: number;
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "trendPeriod" },
          },
          type: {
            kind: "NonNullType",
            type: {
          ...
          defaultValue: { kind: "EnumValue", value: "thirty_days" },
        },
      ],
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "diffPercent" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "diffDirection" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "agentAnnotation" },
                },
                {
                  kind: "Field",
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "systemCoverage" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalSystems" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "fullyClassified" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "partiallyClassified" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "unclassified" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "withoutSteward" },
                },
                {
                  kind: "Field",
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "privacyRequests" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "overdueCount" },
                },
                {
                  kind: "Field",
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "pendingAction" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "awaitingApproval" },
                      },
                    ],
                  },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "slaHealth" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "label" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "onTrack" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "approaching" },
                      },
                      {
                        kind: "Field",
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "completedAssessments" },
                },
                {
                  kind: "Field",
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "agentBriefing" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "quickActions" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
...
>;
export const DashboardPriorityActionsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "DashboardPriorityActions" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "priorityActions" },
            arguments: [
              {
                kind: "Argument",
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "agentSummary" },
                      },
                      {
                        kind: "Field",
  ...
  DashboardPriorityActionsQuery,
  DashboardPriorityActionsQueryVariables
>;
export const DashboardActivityFeedDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "DashboardActivityFeed" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "page" } },
