...
export type DashboardOverviewQueryVariables = Exact<{
  ...
  actionsPage?: Scalars['Int']['input'];
  actionsSize?: Scalars['Int']['input'];
  activityPage?: Scalars['Int']['input'];
  activitySize?: Scalars['Int']['input'];
}>;


export type DashboardOverviewQuery = { __typename?: 'Query', posture: { __typename?: 'Posture', score: number, band: PostureBand, diffPercent: number, diffDirection: DiffDirection, agentAnnotation: string, dimensions: Array<{ __typename?: 'PostureDimension', dimension: string, label: string, weight: number, score: number, band: PostureBand }> }, trends: { __typename?: 'Trends', period: TrendPeriod, metrics: Array<{ __typename?: 'TrendMetric', key: string, value: number, history: Array<number>, metadata: Record<string, unknown>, diff: number }> }, systemCoverage: { __typename?: 'SystemCoverage', totalSystems: number, fullyClassified: number, partiallyClassified: number, unclassified: number, withoutSteward: number, coveragePercentage: number }, privacyRequests: { __typename?: 'PrivacyRequests', activeCount: number, overdueCount: number, statuses: { __typename?: 'PrivacyRequestStatuses', inProgress: number, pendingAction: number, awaitingApproval: number }, slaHealth: Array<{ __typename?: 'SLAHealthBucket', label: string, onTrack: number, approaching: number, overdue: number }> }, priorityActions: { __typename?: 'PriorityActionsPage', total: number, page: number, size: number, pages: number, items: Array<{ __typename?: 'PriorityAction', id: string, type: DashboardActionType, severity: ActionSeverity, title: string, message: string, agentSummary: string, dueDate?: string | null, actionData: Record<string, unknown>, status: DashboardActionStatus }> }, astralis: { __typename?: 'Astralis', activeConversations: number, completedAssessments: number, awaitingResponse: number, risksIdentified: number }, agentBriefing: { __typename?: 'AgentBriefing', briefing: string, quickActions: Array<{ __typename?: 'QuickAction', label: string, actionType: DashboardActionType, severity: ActionSeverity, actionData: Record<string, unknown> }> }, activityFeed: { __typename?: 'ActivityFeedPage', total: number, page: number, size: number, pages: number, items: Array<{ __typename?: 'ActivityFeedItem', actorType: ActorType, message: string, timestamp: string }> } };
