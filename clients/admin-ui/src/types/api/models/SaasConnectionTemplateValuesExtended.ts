...
export type SaasConnectionTemplateValuesExtended = {
  ...
  secrets: (BigQueryDocsSchema | DatahubDocsSchema | DynamicErasureEmailDocsSchema | DynamoDBDocsSchema | EmailDocsSchema | FidesDocsSchema | GoogleCloudSQLMySQLDocsSchema | GoogleCloudSQLPostgresDocsSchema | ManualWebhookDocsSchema | MariaDBDocsSchema | MongoDBDocsSchema | MSSQLDocsSchema | MySQLDocsSchema | OktaDocsSchema | PostgreSQLDocsSchema | RDSMySQLDocsSchema | RDSPostgresDocsSchema | RedshiftDocsSchema | S3DocsSchema | SaaSSchema | ScyllaDocsSchema | SnowflakeDocsSchema | SovrnDocsSchema | TimescaleDocsSchema | WebsiteSchema);
  instance_key: string;
