...
export enum ScopeRegistryEnum {
  ...
  OPENID_PROVIDER_CREATE = "openid-provider:create",
  OPENID_PROVIDER_READ = "openid-provider:read",
  OPENID_PROVIDER_UPDATE = "openid-provider:update",
  OPENID_PROVIDER_DELETE = "openid-provider:delete",
