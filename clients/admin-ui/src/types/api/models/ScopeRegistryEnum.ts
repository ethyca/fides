...
export enum ScopeRegistryEnum {
  ...
  POLICY_V2_CREATE = "policy_v2:create",
  POLICY_V2_DELETE = "policy_v2:delete",
  POLICY_V2_READ = "policy_v2:read",
  POLICY_V2_UPDATE = "policy_v2:update",
