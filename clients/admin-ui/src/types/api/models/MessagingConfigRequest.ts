...
export type MessagingConfigRequest = {
  ...
  details?: (MessagingServiceDetailsMailgun | MessagingServiceDetailsTwilioEmail | MessagingServiceDetailsMailchimpTransactional | MessagingServiceDetailsAWS_SES | null);
  name?: (string | null);
  key?: (string | null);
  secrets?: (MessagingSecretsMailgunDocs | MessagingSecretsTwilioSMSDocs | MessagingSecretsTwilioEmailDocs | MessagingServiceSecretsMailchimpTransactionalDocs | MessagingServiceSecretsAWS_SESDocs | null);
};
