...
import ColorSelect from "~/mocks/TEMP-system-groups/components/ColorSelect";
import {
  CustomTaxonomyColor,
  SystemGroupCreate,
...
const CreateSystemGroupForm = ({
  ...
  // Mock systems options - in a real implementation, this would come from a systems API
      ...
      {({ isValid, dirty }) => (
        <Form>
          <Flex vertical gap="middle">
            ...
            <ColorSelect name="color" label="Color" />
