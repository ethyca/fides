...
17 questions across 6 requirement groups, mapped 1:1 to Article 27 obligations. All questions are `required: true`. Within each group, `question_order` is 1-indexed from the row position in the table.

### Group 1 (`process_and_purpose`, title: "Process and Purpose", order: 1)
...
| `fria_1_3` | What categories of personal data are processed by the AI system? | List all categories of personal data used as inputs to or generated as outputs by the AI system, including any special category data under GDPR Article 9. | `["privacy_declaration.data_categories", "data_category.name"]` | `full` |

### Group 2 (`duration_and_frequency`, title: "Duration and Frequency", order: 2)
...
### Group 3 (`affected_populations`, title: "Affected Populations", order: 3)

| Key | Question | Guidance | fides_sources | Coverage |
|-----|----------|----------|---------------|----------|
| `fria_3_1` | What categories of natural persons and groups are likely to be affected by the AI system? | Identify all individuals the AI will interact with, evaluate, or make decisions about, both directly and indirectly. | `["privacy_declaration.data_subjects"]` | `partial` |
...
### Group 4 (`risk_identification`, title: "Risk Identification", order: 4)
...
### Group 5 (`human_oversight`, title: "Human Oversight", order: 5)
...
### Group 6 (`mitigation_and_governance`, title: "Mitigation and Governance", order: 6)
...
| `fria_6_2` | What internal governance arrangements are in place for this AI system? | Describe the organizational structure responsible for AI governance, including roles, escalation paths, and review cadences. | `["system.data_security_practices"]` | `partial` |
