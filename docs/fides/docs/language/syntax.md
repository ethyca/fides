...
The Fides language is intentionally simple. To assure this, Fides declarations use predefined primitives to describe your dataset, application or define a policy. These predefined primitives exist as part of the Fides taxonomy which is maintained in your fidesctl server. 
